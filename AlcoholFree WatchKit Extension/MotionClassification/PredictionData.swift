...
class PredictionData {
    ...
    func initializeStateOutput() {
        print("StateOutput 초기화")
        for index in 0..<400 {
            stateOutput[index] = 0
        }
    }
